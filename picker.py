...
Головний критерій простий: обличчя має виглядати нормальним і живим.

ЖИВІ ЕМОЦІЇ — ЦЕ ДОБРЕ. Усмішка, радість, здивування, зацікавленість,
задоволення, легкий сміх. Такий кадр кращий за нейтральний, якщо обличчя
при цьому виглядає природно.

ВІДКИДАЙ кадри, де обличчя виглядає негарно:
- переляк, тривога, розгубленість, вираз «що відбувається»
- зверхність, зневага, роздратування, втома
- перекошене або криве обличчя, гримаса посеред слова
- обличчя ніби «застигло» між двома виразами, вираз незрозумілий
- сильно напружені м'язи, наморщений лоб, стиснуті губи
- рот широко відкритий під час говоріння, видно зуби чи язик посеред слова

Різниця між добрим і поганим кадром не в емоції, а в тому, чи виглядає
обличчя цілісним і приємним. Радісне обличчя — добре. Перелякане — погано.

Погляд може бути і повз камеру, це нормально, якщо вираз при цьому нормальний.
